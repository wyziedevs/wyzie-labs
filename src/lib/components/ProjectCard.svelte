...
<a
	...
	class="card-fill group relative flex flex-col gap-3 p-4 sm:p-6 border border-border -mt-px -ml-px bg-bg min-h-40 sm:min-h-50 hover:text-bg overflow-hidden"
>
